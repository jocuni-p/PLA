...
return [
    ...
    | modificar cualquiera de estos mensajes aquí.
    |
    */
    ...
    'prohibited_if_accepted' => 'El campo :attribute está prohibido cuando :other esté aceptado.',
    'prohibited_if_declined' => 'El campo :attribute está prohibido cuando :other esté rechazado.',
    ...
    'required_if_accepted' => 'El campo :attribute es obligatorio cuando :other esté aceptado.',
    'required_if_declined' => 'El campo :attribute es obligatorio cuando :other esté rechazado.',
    ...
    | Esto facilita especificar un mensaje personalizado para una regla
    | determinada de un atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se usan para reemplazar el marcador de
    | posición de atributos con algo más legible como "Dirección de correo
    | electrónico" en lugar de "email". Esto nos ayuda a que los mensajes sean
    | más expresivos.
    |
    */
